...
final class ChatViewController: MessagesViewController {
    ...
    private func presentInputActionSheet() {
        let actionSheet = UIAlertController(title: "Прикріпити:",
                                            message: "Оберіть тип файлу",
                                            preferredStyle: .actionSheet)
        actionSheet.addAction(UIAlertAction(title: "Фото", style: .default, handler: { [weak self] _ in
            self?.presentPhotoInputActionsheet()
        }))
        actionSheet.addAction(UIAlertAction(title: "Відео", style: .default, handler: { [weak self]  _ in
            self?.presentVideoInputActionsheet()
        }))
        //actionSheet.addAction(UIAlertAction(title: "Audio", style: .default, handler: {  _ in

        //}))
        actionSheet.addAction(UIAlertAction(title: "Місце", style: .default, handler: { [weak self]  _ in
    ...
    private func presentPhotoInputActionsheet() {
        let actionSheet = UIAlertController(title: "Прикріпити фото",
                                            message: "Оберіть звідки завантажити фото",
                                            preferredStyle: .actionSheet)
    ...
    private func presentVideoInputActionsheet() {
        let actionSheet = UIAlertController(title: "Прикріпити відео",
                                            message: "Оберіть звідки завантажити відео",
                                            preferredStyle: .actionSheet)
        actionSheet.addAction(UIAlertAction(title: "Камера", style: .default, handler: { [weak self] _ in
